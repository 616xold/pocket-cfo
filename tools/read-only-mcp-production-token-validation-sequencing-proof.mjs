...
const changedText = readChangedDocText(changedPaths);
...
const output = {
  ...
  fp0145Absent: verifyFp0145Absent(repoPaths),
  ...
  noRealTokenExamplesFromFp0144:
    planLeakageScan.accepted && changedTokenExampleScan.noRealTokenExamples,
  noJwtLikeExamplesFromFp0144:
    planLeakageScan.accepted && changedTokenExampleScan.noJwtLikeExamples,
  noBearerTokenMaterialFromFp0144:
    planLeakageScan.accepted && changedTokenExampleScan.noBearerTokenMaterial,

...
const proof = McpTokenValidationReadinessProofSchema.parse(
  buildMcpTokenValidationReadinessProof({
    ...
    noSourceMutationFinanceWriteFromFp0132:
      scopeScan.noSourceMutation &&
      scopeScan.noFinanceWrite &&
      durabilityScan.noSourceMutationVerified &&
      durabilityScan.noFinanceWriteVerified,
...
function metadataRouteShapeStillVerified() {
  return (
    ...
    /assertProtectedResourceMetadataRouteInputEvidenceBundleAcceptedForLocalRouteRegistration/u.test(
      metadataRouteSource,
    ) &&
    !/WWW-Authenticate/iu.test(metadataRouteSource)
  );

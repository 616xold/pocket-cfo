...
- FP-0088 is active as `V2H-read-only-chatgpt-app-mcp-premium-ui-security-master-plan`, a docs-and-plan plus proof-gate compatibility slice that plans premium UI and security readiness only

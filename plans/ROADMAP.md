...
- `F6K — close/control acknowledgement`
  - later only if operator need is proven after the internal readiness foundation; start only through a new Finance Plan, and do not create FP-0060 from roadmap text alone

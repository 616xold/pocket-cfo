...
The shipped F6Q slice is exactly `F6Q-close-control-certification-boundary-foundation`, and no F6R implementation has started.
...
- `F6R — additional source-pack expansion`
  - later only after a new Finance Plan and after the shipped source packs remain green and source-backed

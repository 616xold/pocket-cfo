...
This file records the plugins available in this Codex local thread and the repo-local Pocket CFO plugin used for the FP-0117 OAuth/token/session/auth implementation sequencing and proof-gate compatibility slice.
...
- `pocket-cfo-codex-operator`
  ...
  - Skills invoked for this FP-0117 docs-and-plan plus proof-gate compatibility master plan, OAuth/token/session/auth implementation sequencing, protected-resource metadata readiness planning, doc-refresh, validation, and handoff slice:

...
This file records the plugins available in this Codex local thread and the repo-local Pocket CFO plugin used for the FP-0109 local-only/read-only evidence tool dispatch adapter implementation slice.
...
- `pocket-cfo-codex-operator`
  ...
  - Skills invoked for this FP-0109 evidence tool dispatch adapter, proof-gate bridge, doc-refresh, validation, and handoff slice:

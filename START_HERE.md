...
`plans/FP-0073-final-f6-v1-exit-audit-and-handoff.md` is the active F6Z final audit/handoff contract. It is implementation-ready for a future F6Z audit slice, but this docs refresh does not start provider integration, actual certification, report release, delivery, approvals, runtime-Codex, source mutation, finance writes, or autonomous action.

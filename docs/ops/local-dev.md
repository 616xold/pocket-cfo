...
`plans/FP-0059-operator-notification-readiness-foundation.md` is the shipped F6J record for one deterministic internal operator attention/readiness foundation. `plans/FP-0060-close-control-acknowledgement-foundation.md` is the shipped F6K record for one deterministic read-only internal close/control acknowledgement-readiness foundation. `plans/FP-0061-source-pack-expansion-foundation.md` is the active F6L implementation-ready contract for one future bank/card source-pack foundation; no F6L implementation has started. Do not start broader later-F5 work, multi-monitor F6 work, F6M or later planning, runtime-codex monitoring, delivery behavior, notification providers, outbox sends, email, Slack, SMS, webhooks, payables investigations, policy/covenant investigations, approvals, report conversion, payment behavior, payment instructions, vendor-payment recommendations, legal or policy advice, collection instructions, customer-contact instructions, autonomous finance action, monitor reruns, automatic mission creation, or work beyond FP-0061 from this doc.
...
6. run discovery, reporting, monitoring, close/control, and operator-readiness work only through a named active Finance Plan when one exists; FP-0052 records the shipped F6C collections-pressure monitor slice, FP-0053 records the shipped F6D payables-pressure monitor slice, FP-0054 records the shipped F6E policy/covenant threshold monitor slice, FP-0055 records the shipped F6F monitor demo replay and stack-pack foundation, FP-0056 records the shipped F6G manual collections-pressure alert investigation handoff only, FP-0057 records the shipped F6H close/control checklist foundation, FP-0058 records the shipped F6I demo replay proof expansion with normalized close/control checklist expected output, FP-0059 records the shipped F6J internal operator attention/readiness foundation, and FP-0060 records the shipped F6K internal close/control acknowledgement-readiness foundation

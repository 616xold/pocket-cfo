...
Do not reopen F4C2, do not repeat F5A through F5C4E work, and do not start F6 early; the next code thread should execute `plans/FP-0046-circulation-log-and-first-board-packet-circulation-record-foundation.md` rather than authoring another broad later-F5 umbrella plan.

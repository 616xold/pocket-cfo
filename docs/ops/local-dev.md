...
6. run discovery, reporting, monitoring, and close/control work only through a named active Finance Plan when one exists; FP-0052 records the shipped F6C collections-pressure monitor slice, FP-0053 records the shipped F6D payables-pressure monitor slice, FP-0054 records the shipped F6E policy/covenant threshold monitor slice, FP-0055 records the shipped F6F monitor demo replay and stack-pack foundation, FP-0056 records the shipped F6G manual collections-pressure alert investigation handoff only, and FP-0057 is the active F6H close/control checklist contract
...
- FP-0057 defines the next close/control checklist foundation, but no packaged checklist smoke exists until implementation lands

...
- F6J did not add source mutations, monitor families, discovery families, monitor reruns, missions, runtime-codex writeups, delivery, notification providers, outbox sends, email, Slack, SMS, webhooks, approvals, reports, accounting writes, bank writes, tax filings, legal or policy advice, payment instructions, collection instructions, customer-contact instructions, autonomous remediation, or F6K implementation
- `FP-0060` is now the active F6K implementation-ready contract for internal close/control acknowledgement readiness only; it does not add source mutations, runtime-codex, delivery, approvals, reports, finance actions, monitor families, or discovery families

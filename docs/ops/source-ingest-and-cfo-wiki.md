...
- `FP-0075` is the active F8/v1 future-scope triage contract; it is docs-and-validation-only and must not add source ingest, CFO Wiki compiler behavior, product runtime behavior, provider integrations, delivery, outbox sends, report release, approvals, actual certification, runtime-codex, generated prose, source mutation, finance writes, PDF/OCR/vector search, or autonomous action
...
FP-0075 also does not make source packs imply provider integration, delivery, report release, certification, approval, source mutation, finance writes, generated prose, PDF/OCR/vector search, or autonomous action; it only records future-scope triage.

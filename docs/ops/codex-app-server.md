...
`plans/FP-0074-v1-launch-readiness-and-active-doc-hardening.md` remains docs-and-validation-only. It does not add runtime-Codex finance actions, launch-readiness drafting, notification prose, external communication prose, provider integration, actual certification, delivery, report release, approval workflow, source mutation, finance writes, generated prose, FP-0075, or autonomous action.
`plans/FP-0075-v1-future-scope-triage-and-roadmap-hardening.md` is the active F8/v1 future-scope triage contract. It remains docs-and-validation-only and does not add runtime-Codex finance actions, future-scope drafting, notification prose, external communication prose, provider integration, actual certification, delivery, report release, approval workflow, source mutation, finance writes, generated prose, FP-0076, F8 implementation, or autonomous action.

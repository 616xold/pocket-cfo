...
`plans/FP-0048-board-packet-circulation-actor-correction-and-chronology-hardening.md` now serves as the shipped F5C4H record, already includes the first shipped actor-correction slice, and keeps that work runtime-free as well.

...
- **V2F benchmark/community pack foundation**: active through FP-0086 as docs-and-plan-only benchmark/community contract planning. The first implementation must be SafeDemoDataPolicy-first and docs/proof-only; no eval datasets, fixtures, sample data, source-pack behavior, package scripts, model calls, public app/MCP work, source mutation, finance writes, or autonomous action may start from this boundary doc alone.

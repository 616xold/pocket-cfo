...
- **V2W read-only ChatGPT App/MCP endpoint architecture proof-contract foundation**: shipped through FP-0103.

## Active V2 Plan

- No unfinished V2 Finance Plan is open after [FP-0103](../plans/FP-0103-read-only-chatgpt-app-mcp-endpoint-architecture-proof-contracts-foundation.md) closeout. Public app implementation, route/UI implementation beyond the FP-0094/FP-0096/FP-0097 single local route boundary, endpoints, OAuth/token/session implementation, remote MCP deployment, Apps SDK UI resources, app submission, provider/certification/delivery/deployment, and V2G expansion beyond the shipped local proof-only contracts, descriptor/envelope foundation, FP-0098 readiness/security/submission-boundary plan, FP-0099 security threat-model/platform-boundary plan, FP-0100 local security boundary contracts, FP-0101 implementation sequencing/platform-readiness plan, and FP-0103 endpoint architecture proof-contract foundation and FP-0102 endpoint/OAuth/remote-MCP architecture plan still require a later named Finance Plan.

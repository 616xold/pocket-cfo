...
FP-0106 is the shipped V2Z local/proof-only/read-only MCP protocol envelope and tool-dispatch proof-contract foundation for the future public read-only ChatGPT App/MCP `/mcp` path. It defines the future protocol envelope, accepted and rejected MCP/JSON-RPC method families, exact V2G read-only tool dispatch, structured evidence/refusal envelopes, argument validation, invalid-tool fail-closed behavior, auth deferral, logging redaction, no-route/no-runtime/no-endpoint posture, no-OpenAI-API/model proof boundaries, FP-0105/0104/0103/0100 preservation, and FP-0107 absence while adding no product code, UI implementation, route, endpoint, OAuth/token/session implementation, remote MCP server implementation or deployment, Apps SDK iframe/resource registration, app submission, OpenAI API/model call, schema, migration, package script, eval dataset, fixture, sample data, source pack, screenshot, generated image, public asset, listing copy, app-submission artifact, source mutation, finance write, generated product prose, runtime-Codex finance output, autonomous action, or public app implementation.
...
- **V2Z read-only ChatGPT App/MCP protocol envelope and tool-dispatch proof contracts**: shipped through FP-0106 as local/proof-only/read-only pure domain contracts, focused specs, direct proof tooling, and proof-gate compatibility only, with no product code, UI implementation, route, endpoint, OAuth/token/session implementation, remote MCP server implementation or deployment, Apps SDK iframe/resource registration, app submission, OpenAI API/model call, screenshot, generated image, public asset, listing copy, app-submission artifact, source mutation, finance write, product runtime behavior, public app implementation, or FP-0107.

## Latest Shipped V2 Plan

- **V2Z read-only ChatGPT App/MCP protocol envelope and tool-dispatch proof contracts**: shipped through FP-0106.

## Active V2 Plan

- No unfinished V2 Finance Plan is open after [FP-0106](../plans/FP-0106-read-only-chatgpt-app-mcp-protocol-envelope-tool-dispatch-proof-contracts.md) closeout. Public app implementation, route/UI implementation beyond the FP-0094/FP-0096/FP-0097 single local route boundary, endpoints, OAuth/token/session implementation, remote MCP deployment, Apps SDK UI resources, app submission, provider/certification/delivery/deployment, and V2G expansion beyond the shipped local proof-only contracts, descriptor/envelope foundation, FP-0098 readiness/security/submission-boundary plan, FP-0099 security threat-model/platform-boundary plan, FP-0100 local security boundary contracts, FP-0101 implementation sequencing/platform-readiness plan, FP-0102 endpoint/OAuth/remote-MCP architecture plan, FP-0103 endpoint architecture proof-contract foundation, FP-0104 endpoint implementation readiness plan, FP-0105 endpoint route ownership proof-contract foundation, and FP-0106 protocol envelope/tool-dispatch proof-contract foundation still require a later named Finance Plan.

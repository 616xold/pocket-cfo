...
- F6Z active implementation-ready final F6/v1 exit audit and handoff contract in `plans/FP-0073-final-f6-v1-exit-audit-and-handoff.md`, limited to docs-and-validation only with no product runtime behavior
...
`plans/FP-0073-final-f6-v1-exit-audit-and-handoff.md` is now the active implementation-ready F6Z final audit and handoff contract; it does not start F6Z implementation, provider integration, actual certification, report release, delivery, approvals, runtime-Codex, source mutation, finance writes, or autonomous action.

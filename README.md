...
- V2AA read-only ChatGPT App/MCP local Fastify route adapter foundation through [FP-0107](plans/FP-0107-read-only-chatgpt-app-mcp-local-fastify-mcp-route-adapter-foundation.md), shipped as exactly one local/control-plane `POST /mcp` protocol shell. It handles JSON-RPC shape for `initialize`, `ping`, `notifications/initialized`, `tools/list`, structured fail-closed errors, and fail-closed `tools/call` without OAuth/token/session handling, remote MCP deployment, Apps SDK resources, public app behavior, app submission, OpenAI API/model calls, source mutation, finance writes, provider calls, external communications, public assets, or real read-only evidence dispatch

Any implementation beyond the shipped FP-0107 local `/mcp` route-adapter shell, FP-0106 MCP protocol envelope and tool-dispatch proof contracts, FP-0105 endpoint route ownership and transport-adapter proof contracts, FP-0104 endpoint implementation readiness plan, FP-0103 endpoint architecture proof-contract foundation, FP-0102 endpoint/OAuth/remote-MCP architecture plan, FP-0101 public-app implementation sequencing plan, FP-0100 local public-app security boundary contracts, FP-0099 public-app security threat-model/platform-boundary plan, FP-0098 public-app readiness/security/submission-boundary plan, FP-0097 existing-route local visual QA foundation, FP-0096 existing-route local state-matrix foundation, FP-0095 docs-only state-matrix/visual QA plan, FP-0094 single local preview route foundation, shipped FP-0093 route-readiness plan, shipped FP-0092 local composition/accessibility boundary, shipped FP-0091 local component-only boundary, shipped FP-0090 implementation readiness plan, shipped FP-0089 design-system readiness plan, shipped FP-0088 premium UI/security readiness plan, V2G expansion beyond the shipped FP-0087 local proof-only contract and descriptor/envelope foundation, V2F expansion beyond the shipped FP-0086 docs/proof-only benchmark/community foundation, V2E expansion beyond the shipped FP-0085 local/internal proof-only bounded LLM orchestration foundation, V2D expansion beyond the shipped FP-0084 read-only Evidence Atlas UI foundation, V2B expansion beyond FP-0081, V2C expansion beyond the shipped local/internal contract, public ChatGPT App/MCP deployment, and later tracks remain future-plan-only. See [docs/V2_BOUNDARY.md](docs/V2_BOUNDARY.md).

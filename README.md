...
`plans/FP-0063-close-control-review-summary-foundation.md` is now the active implementation-ready F6N contract for a deterministic internal close/control review summary. It is not certification, close complete, sign-off, attestation, report release, report circulation, external delivery, approval, runtime-Codex drafting, generated prose, monitor rerun, mission creation, source mutation, finance write, legal/policy/payment/collection/customer-contact instruction, autonomous action, a new monitor family, or a new discovery family.

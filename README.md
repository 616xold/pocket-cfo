...
`plans/FP-0074-v1-launch-readiness-and-active-doc-hardening.md` is the shipped F7/v1 launch-readiness and active-doc hardening record. It is docs-and-validation-only, added no product runtime behavior, created no FP-0075, and leaves F6V provider integration plus F6X actual certification future-plan-only.

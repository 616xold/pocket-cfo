...
`plans/FP-0074-v1-launch-readiness-and-active-doc-hardening.md` is the active F7/v1 launch-readiness and active-doc hardening contract. It is docs-and-validation-only, does not start product runtime behavior, and leaves F6V provider integration plus F6X actual certification future-plan-only.

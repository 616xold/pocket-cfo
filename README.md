...
- V2E bounded LLM orchestration through [FP-0085](plans/FP-0085-bounded-llm-orchestration-foundation.md), active as an implementation-ready plan only; implementation has not started and must stay local/internal proof-only unless the plan is amended
- V2F benchmark/community pack, future-plan-only
- V2G optional distribution tracks, future-plan-only

Any V2E implementation beyond the active FP-0085 local/internal proof-only plan, V2D expansion beyond the shipped FP-0084 read-only Evidence Atlas UI foundation, V2B expansion beyond FP-0081, V2C expansion beyond the shipped local/internal contract, V2F community packs, public ChatGPT App/MCP deployment, and later tracks remain future-plan-only. See [docs/V2_BOUNDARY.md](docs/V2_BOUNDARY.md).

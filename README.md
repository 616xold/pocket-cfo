...
Current V2 sequence after the shipped FP-0081 foundation:
...
- V2C read-only agent/MCP/ChatGPT Evidence App alpha through [FP-0082](plans/FP-0082-read-only-mcp-chatgpt-evidence-app-alpha.md), active as a docs-and-plan-only read-only evidence contract with no implementation in the planning slice
- V2D Evidence Atlas UI
- V2E bounded LLM orchestration
- V2F benchmark/community pack
- V2G optional distribution tracks

Any V2B expansion beyond FP-0081 needs a future named plan. V2C implementation and later tracks remain future-plan-only. See [docs/V2_BOUNDARY.md](docs/V2_BOUNDARY.md).

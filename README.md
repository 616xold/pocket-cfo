...
F6T shipped one deterministic internal close/control certification-safety/readiness foundation through `GET /close-control/companies/:companyKey/certification-safety`, derived only from shipped F6Q certification-boundary, F6S human-confirmation, and F6N review-summary posture. It is explicitly not actual certification, certified status, close complete, sign-off, attestation, assurance, legal opinion, audit opinion, approval, report creation, report release, report circulation, external delivery, provider calls, provider credentials, provider jobs, outbox send behavior, scheduled delivery, auto-send, runtime-Codex, generated prose, mission creation, monitor rerun/result creation, source mutation, finance write, payment behavior, advice/instruction, customer-contact instruction, autonomous action, a new monitor family, or a new discovery family. F6W planning is governed by `plans/FP-0071-policy-covenant-document-source-pack-foundation.md`; F6V, F6X, and later planning must wait for new Finance Plans.

`plans/FP-0071-policy-covenant-document-source-pack-foundation.md` is the active F6W implementation-ready contract.
F6W is limited to one deterministic policy/covenant document source-pack foundation over existing source registry and CFO Wiki bind, compile, and read routes only. It is not a monitor family, discovery family, product runtime behavior, runtime-Codex behavior, provider integration, delivery, approval, report release, legal or policy advice, audit opinion, certification, close-complete posture, source mutation beyond proof upload/bind/compile setup, or autonomous finance action.

...
21. active F6I stack-pack expansion and close/control demo foundation, recorded in `plans/FP-0058-stack-pack-expansion-and-close-control-demo-foundation.md`, which should extend the existing deterministic demo replay proof with normalized close/control checklist expected output and no model-scored benchmark dataset yet
22. wiki compilation quality
23. provenance, freshness disclosure, and contradiction handling

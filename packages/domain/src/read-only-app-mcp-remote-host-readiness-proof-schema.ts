...
export const McpRemoteHostReadinessProofSchema = z
  .object({
    ...
    fp0114RemoteHostReadinessPostmergeProofDurabilityVerified: trueLiteral,
    remoteDeploymentRepositoryInventoryStillVerified: trueLiteral,
    noDeploymentConfigRepositoryInventoryVerified: trueLiteral,
    remoteMcpRuntimeRepositoryInventoryStillVerified: trueLiteral,
    remoteHostImplementationSequencingPlanBoundaryVerified: trueLiteral,
    ...
    noRouteBehaviorChangeFromFp0115: trueLiteral,
    noNewRoutePathFromFp0115: trueLiteral,
    noRemoteMcpDeploymentFromFp0115: trueLiteral,
    noDeploymentConfigFromFp0115: trueLiteral,
    noOauthImplementationFromFp0115: trueLiteral,
    noTokenSessionImplementationFromFp0115: trueLiteral,
    noAuthMiddlewareImplementationFromFp0115: trueLiteral,
    noAppsSdkResourceFromFp0115: trueLiteral,
    noAppSubmissionFromFp0115: trueLiteral,
    noDbQueriesFromFp0115: trueLiteral,
    noSchemaMigrationsFromFp0115: trueLiteral,
    noPackageScriptsFromFp0115: trueLiteral,
    noOpenAiApiCallsFromFp0115: trueLiteral,
    noProviderExternalCallsFromFp0115: trueLiteral,
    noSourceMutationFinanceWriteFromFp0115: trueLiteral,
    noPublicAssetsSubmissionArtifactsFromFp0115: trueLiteral,
    noRouteBehaviorChangeFromFp0116: trueLiteral,
    noNewRoutePathFromFp0116: trueLiteral,
    noRemoteMcpDeploymentFromFp0116: trueLiteral,
    noDeploymentConfigFromFp0116: trueLiteral,
    noOauthImplementationFromFp0116: trueLiteral,
    noTokenSessionImplementationFromFp0116: trueLiteral,
    noAuthMiddlewareImplementationFromFp0116: trueLiteral,
    noAppsSdkResourceFromFp0116: trueLiteral,
    noAppSubmissionFromFp0116: trueLiteral,
    noDbQueriesFromFp0116: trueLiteral,
    noSchemaMigrationsFromFp0116: trueLiteral,
    noPackageScriptsFromFp0116: trueLiteral,
    noOpenAiApiCallsFromFp0116: trueLiteral,
    noProviderExternalCallsFromFp0116: trueLiteral,
    noSourceMutationFinanceWriteFromFp0116: trueLiteral,
    noPublicAssetsSubmissionArtifactsFromFp0116: trueLiteral,
    noListingCopyGeneratedPublicProseFromFp0116: trueLiteral,

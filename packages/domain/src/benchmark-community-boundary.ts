...
export const BENCHMARK_AUTHORITY_LAYERS = [
  "raw_sources",
  "finance_twin",
  "cfo_wiki",
  "evidence_index",
  ...
  "v2e_bounded_orchestration",
  "v2f_benchmark_community_contracts",
] as const satisfies readonly z.infer<typeof BenchmarkAuthorityLayerSchema>[];

export const BenchmarkAuthorityLayersSchema = z.tuple([
  z.literal("raw_sources"),
  z.literal("finance_twin"),
  z.literal("cfo_wiki"),
  z.literal("evidence_index"),
  z.literal("v2c_evidence_tools"),
  z.literal("v2d_evidence_atlas"),
  z.literal("v2e_bounded_orchestration"),
  z.literal("v2f_benchmark_community_contracts"),
]);

export const BenchmarkNoRuntimeBoundarySchema = z
  .object({
    ...
    noGeneratedProductProse: z.literal(true),
    noRuntimeCodex: z.literal(true),
    noAutonomousAction: z.literal(true),
  })
  .strict();

export const ArchitectureMapSchema = z
  .object({
    schemaVersion: z.literal(BENCHMARK_COMMUNITY_SCHEMA_VERSION),
    authorityLayers: BenchmarkAuthorityLayersSchema,
...
export const ContributorChallengeSchema = z
  .object({
    schemaVersion: z.literal(BENCHMARK_COMMUNITY_SCHEMA_VERSION),
...
>;
export type BenchmarkAuthorityLayers = z.infer<
  typeof BenchmarkAuthorityLayersSchema
>;

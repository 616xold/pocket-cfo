...
export const AppMcpDescriptorEnvelopeProofSchema = z
  .object({
    ...
    noRemoteMcpDeploymentFromFp0100: trueLiteral,
    noAppsSdkResourceFromFp0100: trueLiteral,
    noAppSubmissionFromFp0100: trueLiteral,
    noOpenAiApiCallsFromFp0100: trueLiteral,
    noSourceMutationFinanceWriteFromFp0100: trueLiteral,
    noPublicAssetsSubmissionArtifactsFromFp0100: trueLiteral,
